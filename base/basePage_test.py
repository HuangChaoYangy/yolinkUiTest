...
class BasePage_test(initsetupteardown):
    def __init__(self):
        self.driver = self.init_driver()
        self.driver.implicitly_wait(5)

    def find_element_o_t(self,loc,timeout=30,poll=0.5):
        """
        根据定位获取单个元素
    ...
    def find_element_in_t(self,loc,timeout=30,poll=0.5):
        """
        根据定位获取单个元素
        :param loc: 查找元素方式及属性值，元祖方式传递（By.ID,ID属性值）
        :param timeout: 等待时长
    ...
    def click_element_t(self,loc,desc=''):
        """
        点击操作
        :param loc: 查找元素方式及属性值，元祖方式传递（By.ID,ID属性值）
        :return:
        """
        self.find_element_o_t(loc).click()

    def input_text_t(self,loc,text,desc=''):
        """
        输入操作
        :param loc: 查找元素方式及属性值，元祖方式传递（By.ID,ID属性值）
        :param text: 输入的值
        :return:
        """
        ele = self.find_element_o_t(loc)
        ele.clear()
        ele.send_keys(text)

    def long_press_element_t(self,ele,duration=2000,desc=''):
        """
        长按操作
        :param loc:
        :return:
    ...
    def swipe_t(self,start_x,start_y,end_x,end_y,duration):
        '''
        滑动操作
        :param start_x: 左滑的坐标
        :param start_y: 右滑的坐标
    ...
    def get_screen_t(self, screen_name):
        '''
        全屏截图
        :param screen_name:
        :return:
